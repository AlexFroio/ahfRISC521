                ...
                for i in OpDict:
                    if wordCheck == i and printFlag is False:
                        ...
                        if OpDict[i] == 0 or OpDict[i] == 1:
                            ...
                            pprint('Opcode is' + OpCode + ' Rj is ' + Rj)
                            ...
                            if holdVar[0] == 'JMP':
                                ...
                                if holdVar[1] in jmpTemp:
                                    ...
                                    pprint("No such jump exists!")
                        elif OpDict[i] == 3 or OpDict[i] == 2 or OpDict[i] == 5 or OpDict[i] == 6 or OpDict[i] == 10 or OpDict[i] == 11:
                            OpCode = '{:04b}'.format(OpDict[i])
                            rMatch = re.findall('\d+', encode)
                            Ri = '{:05b}'.format(int(rMatch[0], 10))
                            ...
                            Rj = '{:05b}'.format(int(re.search('((?<=\s)[0-9xA-F]+)', encode).group(0), 16))
                            codeOutIW0 = bin(int(OpCode + Ri + Rj, 2))
                            romTemp.append('{:03x}'.format(j) + " : " + '{:04x}'.format(int(codeOutIW0, 2)))
                            j = j + 1
                        elif OpDict[i] == 9:
